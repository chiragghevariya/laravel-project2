    ...
    <body>
        ...
        <section class="showcase">
            <div class="container-fluid p-0">
                ...
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('index/assets/img/bg-showcase-3.jpg')"></div>
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
        ...
        <section class="testimonials text-center bg-light">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="index/assets/img/testimonials-2.jpg" alt="..." />
                            <h5>Fred S.</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                            <img class="img-fluid rounded-circle mb-3" src="index/assets/img/testimonials-3.jpg" alt="..." />
                            <h5>Sarah W.</h5>
