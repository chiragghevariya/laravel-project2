      ...
      <div class="container">
        ...
        <div class="row counters"> 
          <?php
                          ...
                          $sql="select * from `basic_settings`"; 
       ...
       echo'   <div class="col-lg-3 col-6 text-center">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="'.$projects.'" data-purecounter-duration="1" class="purecounter"></span>
            <p>Projects</p>
          </div>

          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="'.$hours.'" data-purecounter-duration="1" class="purecounter"></span>
                          ...
                          $sql="select * from `basic_settings`"; 
                           ...
                           if($result){
                             ...
                             while($row=mysqli_fetch_assoc($result))
                             {
                              ...
                              $description=$row['por_description'];
                          ...
                          $sql="select * from `basic_settings`"; 
                           ...
                           if($result){
                             ...
                             while($row=mysqli_fetch_assoc($result))
                             {
                              ...
                              $description=$row['tes_description'];
                            

              echo' <span>Testimonials</span>
                    <h2>'.$testimonials.'</h2>
                    <p>'.$description.'</p>';
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            <form action="frontcontactinsert.php" method="post" role="form" class="form">
              <div class="row">
    ...
    <div class="footer-top">
      ...
      <div class="container">
                          ...
                          $sql="select * from `basic_settings`"; 
                           ...
                           if($result){
                             ...
                             while($row=mysqli_fetch_assoc($result))
                             {
                              ...
                              $enno=$row['enno'];
                              $description=$row['enno_description'];
        ...
        <div class="row footer-newsletter justify-content-center">
          <div class="col-lg-6">
            <form action="frontsubscribe_insert.php" method="post">
              <input type="email" name="email" placeholder="Enter your Email"><input type="submit"  name="submit"   value="Subscribe">
            </form>
          </div>
        </div>
<div class="social-links">
          ...
          <a href="'. $url.'" class="twitter"><i class="'. $class.'"></i></a>
